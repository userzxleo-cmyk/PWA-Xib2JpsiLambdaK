...
//  setdlz->readFromFile("func/fitL-IndividialLS-BWfactor-converted.func");
  ...
  setdlz->readFromFile(TString::Format("bk/testKM5Pc3-4440%s-4457%s-4312%s-4500%s.func",nameZ5, name, nameZ4, nameZ2).Data());
// setdlz->readFromFile("test.func");
//  setdlz->readFromFile(TString::Format("func/testKM5Pc2-4440%s-4457%s-4312%s-4500%s.func",nameZ5, name, nameZ4, nameZ2).Data());
