...
int main(int argc, char **argv) {
    ...
    Static_Check::Systematics::check_flags<false,    // Isospin Sigmac(*)D(*)
                                           true,     // Linear production term in K-matrix
                                           false,    // Self-scattering for Sigmac(*)D(*) channels
    ...
    auto parser_args =
        Parser::parse_args<has_broad_Pc>(argc,
                                         argv,
                                         "systematic_LinearKMatrixNonResonant",
                                         "Fits systematic model: Jpsip K-matrix production of "
                                         "non-resonant has an additional linear term");
...
// Use a different resonance with linear K-matrix non-resonant production
#include "RooTDalitz/ResX.h"
#include "RooTDalitz/ResZ_LinearKMNR.h"
