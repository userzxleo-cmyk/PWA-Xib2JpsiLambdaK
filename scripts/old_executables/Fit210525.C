...
//  g1_Z5.setVal(0.359204);  
 ...
 // width_1405.setConstant(1);
  ...
  p_Bp_Z5.setVal(0);
  a_Bp_Z5.setVal(0);
  a_Bp_Z5.setRange(-1,1);
  p_Bp_Z5.setRange(-1,1);   
...
g4_Z5.setRange(-2,2);
g2_Z.setVal(0); g2_Z.setConstant(1);
//  setdlz->readFromFile("func/testKMOldLNR-4440m3-4457m1-4312m1.func");      
  NLL2 = doFit(obs, list, listZ,  data_fit, 0, true, errlist);         
  setdlz->writeToFile(TString::Format("func/testKMOldLNR-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKMOldLNR-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
