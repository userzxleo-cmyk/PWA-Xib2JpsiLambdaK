  ...
  L_1600->add(RooRealConstant::value(1)); //parity
    ...
    //===Lambda(1610) 1/2+ syst. check
  RooRealVar m0_1610("m0_1610","m0",1.6, 1.45, 1.7);
  RooRealVar width_1610("width_1610","width",0.15, 0.01, 0.5);
  // a &phase [1/2,1] [1/2,0] [-1/2, 0] [-1/2, -1] [3/2,1] [-3/2, -1]
  RooRealVar a_p1p1_1610("a_p1p1_1610","",0.05);
  RooRealVar p_p1p1_1610("p_p1p1_1610","",0.05);
  RooRealVar a_p100_1610("a_p100_1610","",0.05);
  RooRealVar p_p100_1610("p_p100_1610","",0.05);
  RooRealVar a_m100_1610("a_m100_1610","",0.05);
  RooRealVar p_m100_1610("p_m100_1610","",0.05);
  RooRealVar a_m1m1_1610("a_m1m1_1610","",0.05);
  RooRealVar p_m1m1_1610("p_m1m1_1610","",0.05);
  RooRealVar a_p3p1_1610("a_p3p1_1610","",0.05);
  RooRealVar p_p3p1_1610("p_p3p1_1610","",0.05);
  RooRealVar a_m3m1_1610("a_m3m1_1610","",0.05);
  RooRealVar p_m3m1_1610("p_m3m1_1610","",0.05);

  RooArgList* L_1610 = new RooArgList(a_p1p1_1610,p_p1p1_1610,
                                      a_p100_1610,p_p100_1610,
                                      a_m100_1610,p_m100_1610,
                                      a_m1m1_1610,p_m1m1_1610,"L_1610");
  L_1610->add(a_p3p1_1610);
  L_1610->add(p_p3p1_1610);
  L_1610->add(a_m3m1_1610);
  L_1610->add(p_m3m1_1610);
  L_1610->add(scRe);
  L_1610->add(scIm);
  L_1610->add(m0_1610);
  L_1610->add(width_1610);
  L_1610->add(RooRealConstant::value(typeR));
  L_1610->add(RooRealConstant::value(1.));//2 x spin
  L_1610->add(RooRealConstant::value(1)); //parity
...
//  list->Add(L_2350);
  ...
  // a &phase [1/2,1] [1/2,0] [-1/2, 0] [-1/2, -1] [3/2,1] [-3/2, -1]
  RooRealVar a_p1p1_2340("a_p1p1_2340","",0.01, -100, 100);
  RooRealVar p_p1p1_2340("p_p1p1_2340","",0.01, -100, 100);
  ...
  // a &phase [1/2,1] [1/2,0] [-1/2, 0] [-1/2, -1] [3/2,1] [-3/2, -1]
  RooRealVar a_p1p1_1910("a_p1p1_1910","",0.01, -100, 100);
  RooRealVar p_p1p1_1910("p_p1p1_1910","",0.01, -100, 100);
  ...
  // a &phase [1/2,1] [1/2,0] [-1/2, 0] [-1/2, -1] [3/2,1] [-3/2, -1]
  RooRealVar a_p1p1_2130("a_p1p1_2130","",0.01, -100, 100);
  RooRealVar p_p1p1_2130("p_p1p1_2130","",0.01, -100, 100);
...
//  RooDalitzRAmlitude dz;
  ...
  for(int i=0; i<Npoint; ++i) {
    ...
    sprintf(Wname,"SR2_%02d",(i-5>=0 ? i-5 : i+40));
    SRAm2[i] = new RooRealVar(Wname,Wname,sr0[i]*fac);
    SRAm2[i]->setConstant(0);
    Swave2->add(*SRAm2[i]);
    sprintf(Wname,"SI2_%02d",(i-5>=0 ? i-5 : i+40));
