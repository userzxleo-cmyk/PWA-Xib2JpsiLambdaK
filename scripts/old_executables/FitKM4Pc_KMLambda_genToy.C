...
//  rg4_Z4.setConstant(0);    
  setdlz->readFromFile(TString::Format("func/testKM4Pc-KMLambda-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());  
//  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist);  
  
  //setdlz->writeToFile(TString::Format("func/testKM4Pc-KMLambda-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
//  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM4Pc-KMLambda-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data());
  signew->Delete(); 
  }
  return 0;
  if(1) {
