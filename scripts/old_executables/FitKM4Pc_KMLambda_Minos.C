...
//  rg4_Z4.setConstant(0);    
  setdlz->readFromFile(TString::Format("func/testKM4Pc-KMLambda-rndFit-4440%s-4457%s-4312%s-4600%s-seed%d.func",nameZ5, name, nameZ4,nameZ2, seed).Data());  
...
//  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist);  
  ...
  setdlz->writeToFile(TString::Format("func/testKM4Pc-KMLambda-Minos-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
  setdlz->Print("V");
