...
//  setdlz->readFromFile("func/fitL-IndividialLS-BWfactor-converted.func");
  ...
  setdlz->readFromFile(TString::Format("func/testKM5Pc-4440%s-4457%s-4312%s-4500%s.func",nameZ5, name, nameZ4, nameZ2).Data());    
  setdlz->readFromFile("fitfix.func");
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM5Pc2-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
