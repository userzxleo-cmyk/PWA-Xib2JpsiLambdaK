...
int main(int argc, char **argv) {
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        argc,
        argv,
        "systematic_SelfScattering_NoBroadPcNo4Ls",
        "Fits systematic model: (1) Fits systematic model: Sigmac(*)D(*) channels have non-zero "
        "self-scattering terms , (2) Remove 4 new Lz resonances and (3) no broad Pc");
...
#include "RooTDalitz/ResZKM_SelfScattering.h" // Include Sigmac(*)D(*) self-scattering terms
