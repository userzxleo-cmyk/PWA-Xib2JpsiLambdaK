...
int main(int argc, char **argv) {
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        argc,
        argv,
        "systematic_NoBroadPc_PWaveJpsip1p",
        "Fits systematic model: replace BroadPc with non-resonant 1/2+ Jpsip");
...
#include "RooTDalitz/ResZKM_alternateCoupling.h"
    ...
    // Non resonant Jpsi-p p-wave, 3/2+
    listZ->Add(L_ZNR3p);
