...
//  p_L2_Z4.setError(0.1);
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-fullPHSP-fineBinning-2MoreLst-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl;
  ...
  setdlz->writeToFile(TString::Format("func/testKM4Pc-fullPHSP-fineBinning-2MoreLst-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data());
  return 0;
  setdlz->Print("V");
