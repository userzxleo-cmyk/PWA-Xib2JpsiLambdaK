...
//four more couplings
  ...
  RooRealVar a_Bp_ZM1SC2("a_Bp_ZM1SC2","",0.1,-5,5);
  RooRealVar p_Bp_ZM1SC2("p_Bp_ZM1SC2","",0.1,-5,5);
  RooRealVar a_L0_ZM1SC2("a_L0_ZM1SC2","",0);
  RooRealVar p_L0_ZM1SC2("p_L0_ZM1SC2","",0.00);
  RooRealVar a_L1_ZM1SC2("a_L1_ZM1SC2","",0.00);
  RooRealVar p_L1_ZM1SC2("p_L1_ZM1SC2","",0.00);
  RooRealVar a_L2_ZM1SC2("a_L2_ZM1SC2","",0.00);
  RooRealVar p_L2_ZM1SC2("p_L2_ZM1SC2","",0.00);

  RooArgList* L_ZM1SC2 = new RooArgList(a_Bp_ZM1SC1,p_Bp_ZM1SC1,
                                        a_L0_ZM1SC1,p_L0_ZM1SC1,
                                        a_L1_ZM1SC1,p_L1_ZM1SC1,
                                        a_L2_ZM1SC1,p_L2_ZM1SC1,"L_ZM1SC2");
  ...
  RooRealVar a_Bp_ZM1SC3("a_Bp_ZM1SC3","",0.1,-5,5);
  RooRealVar p_Bp_ZM1SC3("p_Bp_ZM1SC3","",0.1,-5,5);
  RooRealVar a_L0_ZM1SC3("a_L0_ZM1SC3","",0);
  RooRealVar p_L0_ZM1SC3("p_L0_ZM1SC3","",0.00);
  RooRealVar a_L1_ZM1SC3("a_L1_ZM1SC3","",0.00);
  RooRealVar p_L1_ZM1SC3("p_L1_ZM1SC3","",0.00);
  RooRealVar a_L2_ZM1SC3("a_L2_ZM1SC3","",0.00);
  RooRealVar p_L2_ZM1SC3("p_L2_ZM1SC3","",0.00);

  RooArgList* L_ZM1SC3 = new RooArgList(a_Bp_ZM1SC1,p_Bp_ZM1SC1,
                                        a_L0_ZM1SC1,p_L0_ZM1SC1,
                                        a_L1_ZM1SC1,p_L1_ZM1SC1,
                                        a_L2_ZM1SC1,p_L2_ZM1SC1,"L_ZM1SC3");
  ...
  RooRealVar a_Bp_ZM1SC4("a_Bp_ZM1SC4","",0.1,-5,5);
  RooRealVar p_Bp_ZM1SC4("p_Bp_ZM1SC4","",0.1,-5,5);
  RooRealVar a_L0_ZM1SC4("a_L0_ZM1SC4","",0);
  RooRealVar p_L0_ZM1SC4("p_L0_ZM1SC4","",4.00);
  RooRealVar a_L1_ZM1SC4("a_L1_ZM1SC4","",0.00);
  RooRealVar p_L1_ZM1SC4("p_L1_ZM1SC4","",0.00);
  RooRealVar a_L2_ZM1SC4("a_L2_ZM1SC4","",0.00);
  RooRealVar p_L2_ZM1SC4("p_L2_ZM1SC4","",0.00);

  RooArgList* L_ZM1SC4 = new RooArgList(a_Bp_ZM1SC1,p_Bp_ZM1SC1,
                                        a_L0_ZM1SC1,p_L0_ZM1SC1,
                                        a_L1_ZM1SC1,p_L1_ZM1SC1,
                                        a_L2_ZM1SC1,p_L2_ZM1SC1,"L_ZM1SC4");
  ...
  RooRealVar a_Bp_ZM3SC2("a_Bp_ZM3SC2","",0.1,-5,5);
  RooRealVar p_Bp_ZM3SC2("p_Bp_ZM3SC2","",0.1,-5,5);
  RooRealVar a_L0_ZM3SC2("a_L0_ZM3SC2","",0);
  RooRealVar p_L0_ZM3SC2("p_L0_ZM3SC2","",0.00);
  RooRealVar a_L1_ZM3SC2("a_L1_ZM3SC2","",0.00);
  RooRealVar p_L1_ZM3SC2("p_L1_ZM3SC2","",0.00);
  RooRealVar a_L2_ZM3SC2("a_L2_ZM3SC2","",0.00);
  RooRealVar p_L2_ZM3SC2("p_L2_ZM3SC2","",0.00);

  RooArgList* L_ZM3SC2 = new RooArgList(a_Bp_ZM3SC1,p_Bp_ZM3SC1,
                                        a_L0_ZM3SC1,p_L0_ZM3SC1,
                                        a_L1_ZM3SC1,p_L1_ZM3SC1,
                                        a_L2_ZM3SC1,p_L2_ZM3SC1,"L_ZM3SC2");
  ...
  RooRealVar a_Bp_ZM3SC3("a_Bp_ZM3SC3","",0.1,-5,5);
  RooRealVar p_Bp_ZM3SC3("p_Bp_ZM3SC3","",0.1,-5,5);
  RooRealVar a_L0_ZM3SC3("a_L0_ZM3SC3","",0);
  RooRealVar p_L0_ZM3SC3("p_L0_ZM3SC3","",0.00);
  RooRealVar a_L1_ZM3SC3("a_L1_ZM3SC3","",0.00);
  RooRealVar p_L1_ZM3SC3("p_L1_ZM3SC3","",0.00);
  RooRealVar a_L2_ZM3SC3("a_L2_ZM3SC3","",0.00);
  RooRealVar p_L2_ZM3SC3("p_L2_ZM3SC3","",0.00);

  RooArgList* L_ZM3SC3 = new RooArgList(a_Bp_ZM3SC1,p_Bp_ZM3SC1,
                                        a_L0_ZM3SC1,p_L0_ZM3SC1,
                                        a_L1_ZM3SC1,p_L1_ZM3SC1,
                                        a_L2_ZM3SC1,p_L2_ZM3SC1,"L_ZM3SC3");
  ...
  RooRealVar a_Bp_ZM3SC4("a_Bp_ZM3SC4","",0.1,-5,5);
  RooRealVar p_Bp_ZM3SC4("p_Bp_ZM3SC4","",0.1,-5,5);
  RooRealVar a_L0_ZM3SC4("a_L0_ZM3SC4","",0);
  RooRealVar p_L0_ZM3SC4("p_L0_ZM3SC4","",4.00);
  RooRealVar a_L1_ZM3SC4("a_L1_ZM3SC4","",0.00);
  RooRealVar p_L1_ZM3SC4("p_L1_ZM3SC4","",0.00);
  RooRealVar a_L2_ZM3SC4("a_L2_ZM3SC4","",0.00);
  RooRealVar p_L2_ZM3SC4("p_L2_ZM3SC4","",0.00);

  RooArgList* L_ZM3SC4 = new RooArgList(a_Bp_ZM3SC1,p_Bp_ZM3SC1,
                                        a_L0_ZM3SC1,p_L0_ZM3SC1,
                                        a_L1_ZM3SC1,p_L1_ZM3SC1,
                                        a_L2_ZM3SC1,p_L2_ZM3SC1,"L_ZM3SC4");
...
//Add several additional Pc states with fixed JP
  ...
  // Non-resonant P-wave 1/2+ and 3/2+
  RooRealVar a_Bp_ZP1SC1("a_Bp_ZP1SC1","",0.001);
  RooRealVar p_Bp_ZP1SC1("p_Bp_ZP1SC1","",0.001);
  RooRealVar a_L0_ZP1SC1("a_L0_ZP1SC1","",0.001);
  RooRealVar p_L0_ZP1SC1("p_L0_ZP1SC1","",0.001);
  RooRealVar a_L1_ZP1SC1("a_L1_ZP1SC1","",0.001);
  RooRealVar p_L1_ZP1SC1("p_L1_ZP1SC1","",0.001);
  RooRealVar a_L2_ZP1SC1("a_L2_ZP1SC1","",0.);
  RooRealVar p_L2_ZP1SC1("p_L2_ZP1SC1","",0.);

  RooArgList* L_ZP1SC1 = new RooArgList(a_Bp_ZP1SC1,p_Bp_ZP1SC1,
              a_L0_ZP1SC1,p_L0_ZP1SC1,
              a_L1_ZP1SC1,p_L1_ZP1SC1,
              a_L2_ZP1SC1,p_L2_ZP1SC1,"L_ZP1SC1");
  RooRealVar fsc_ZP1SC1("fsc_ZP1SC1","",0,-5,5);
  L_ZP1SC1->add(fsc_ZP1SC1);
  L_ZP1SC1->add(RooRealConstant::value(-0.5));
  L_ZP1SC1->add(RooRealConstant::value(0.));
  RooRealVar typeZP1SC1("typeZP1SC1","",RKMNew);
  L_ZP1SC1->add(typeZP1SC1);  //type
  L_ZP1SC1->add(RooRealConstant::value(1));  //2 x spin
  L_ZP1SC1->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP1SC2("a_Bp_ZP1SC2","",0.001);
  RooRealVar p_Bp_ZP1SC2("p_Bp_ZP1SC2","",0.001);
  RooRealVar a_L0_ZP1SC2("a_L0_ZP1SC2","",0.001);
  RooRealVar p_L0_ZP1SC2("p_L0_ZP1SC2","",0.001);
  RooRealVar a_L1_ZP1SC2("a_L1_ZP1SC2","",0.001);
  RooRealVar p_L1_ZP1SC2("p_L1_ZP1SC2","",0.001);
  RooRealVar a_L2_ZP1SC2("a_L2_ZP1SC2","",0.001);
  RooRealVar p_L2_ZP1SC2("p_L2_ZP1SC2","",0.001);

  RooArgList* L_ZP1SC2 = new RooArgList(a_Bp_ZP1SC1,p_Bp_ZP1SC1,
              a_L0_ZP1SC1,p_L0_ZP1SC1,
              a_L1_ZP1SC1,p_L1_ZP1SC1,
              a_L2_ZP1SC1,p_L2_ZP1SC1,"L_ZP1SC1");
  RooRealVar fsc_ZP1SC2("fsc_ZP1SC2","",0,-5,5);
  L_ZP1SC2->add(fsc_ZP1SC2);
  L_ZP1SC2->add(RooRealConstant::value(-0.5));
  L_ZP1SC2->add(RooRealConstant::value(0.));
  RooRealVar typeZP1SC2("typeZP1SC2","",RKMNew);
  L_ZP1SC2->add(typeZP1SC2);  //type
  L_ZP1SC2->add(RooRealConstant::value(1));  //2 x spin
  L_ZP1SC2->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP1SC3("a_Bp_ZP1SC3","",0.001);
  RooRealVar p_Bp_ZP1SC3("p_Bp_ZP1SC3","",0.001);
  RooRealVar a_L0_ZP1SC3("a_L0_ZP1SC3","",0.001);
  RooRealVar p_L0_ZP1SC3("p_L0_ZP1SC3","",0.001);
  RooRealVar a_L1_ZP1SC3("a_L1_ZP1SC3","",0.001);
  RooRealVar p_L1_ZP1SC3("p_L1_ZP1SC3","",0.001);
  RooRealVar a_L2_ZP1SC3("a_L2_ZP1SC3","",0.001);
  RooRealVar p_L2_ZP1SC3("p_L2_ZP1SC3","",0.001);

  RooArgList* L_ZP1SC3 = new RooArgList(a_Bp_ZP1SC1,p_Bp_ZP1SC1,
              a_L0_ZP1SC1,p_L0_ZP1SC1,
              a_L1_ZP1SC1,p_L1_ZP1SC1,
              a_L2_ZP1SC1,p_L2_ZP1SC1,"L_ZP1SC1");
  RooRealVar fsc_ZP1SC3("fsc_ZP1SC3","",0,-5,5);
  L_ZP1SC3->add(fsc_ZP1SC3);
  L_ZP1SC3->add(RooRealConstant::value(-0.5));
  L_ZP1SC3->add(RooRealConstant::value(0.));
  RooRealVar typeZP1SC3("typeZP1SC3","",RKMNew);
  L_ZP1SC3->add(typeZP1SC3);  //type
  L_ZP1SC3->add(RooRealConstant::value(1));  //2 x spin
  L_ZP1SC3->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP1SC4("a_Bp_ZP1SC4","",0.001);
  RooRealVar p_Bp_ZP1SC4("p_Bp_ZP1SC4","",0.001);
  RooRealVar a_L0_ZP1SC4("a_L0_ZP1SC4","",0.001);
  RooRealVar p_L0_ZP1SC4("p_L0_ZP1SC4","",0.001);
  RooRealVar a_L1_ZP1SC4("a_L1_ZP1SC4","",0.001);
  RooRealVar p_L1_ZP1SC4("p_L1_ZP1SC4","",0.001);
  RooRealVar a_L2_ZP1SC4("a_L2_ZP1SC4","",0.001);
  RooRealVar p_L2_ZP1SC4("p_L2_ZP1SC4","",0.001);

  RooArgList* L_ZP1SC4 = new RooArgList(a_Bp_ZP1SC1,p_Bp_ZP1SC1,
              a_L0_ZP1SC1,p_L0_ZP1SC1,
              a_L1_ZP1SC1,p_L1_ZP1SC1,
              a_L2_ZP1SC1,p_L2_ZP1SC1,"L_ZP1SC1");
  RooRealVar fsc_ZP1SC4("fsc_ZP1SC4","",0,-5,5);
  L_ZP1SC4->add(fsc_ZP1SC4);
  L_ZP1SC4->add(RooRealConstant::value(-0.5));
  L_ZP1SC4->add(RooRealConstant::value(0.));
  RooRealVar typeZP1SC4("typeZP1SC4","",RKMNew);
  L_ZP1SC4->add(typeZP1SC4);  //type
  L_ZP1SC4->add(RooRealConstant::value(1));  //2 x spin
  L_ZP1SC4->add(RooRealConstant::value(1));  //parity


  RooRealVar a_Bp_ZP3SC1("a_Bp_ZP3SC1","",0.001);
  RooRealVar p_Bp_ZP3SC1("p_Bp_ZP3SC1","",0.001);
  RooRealVar a_L0_ZP3SC1("a_L0_ZP3SC1","",0.001);
  RooRealVar p_L0_ZP3SC1("p_L0_ZP3SC1","",0.001);
  RooRealVar a_L1_ZP3SC1("a_L1_ZP3SC1","",0.001);
  RooRealVar p_L1_ZP3SC1("p_L1_ZP3SC1","",0.001);
  RooRealVar a_L2_ZP3SC1("a_L2_ZP3SC1","",0.001);
  RooRealVar p_L2_ZP3SC1("p_L2_ZP3SC1","",0.001);

  RooArgList* L_ZP3SC1 = new RooArgList(a_Bp_ZP3SC1,p_Bp_ZP3SC1,
              a_L0_ZP3SC1,p_L0_ZP3SC1,
              a_L1_ZP3SC1,p_L1_ZP3SC1,
              a_L2_ZP3SC1,p_L2_ZP3SC1,"L_ZP3SC1");
  RooRealVar fsc_ZP3SC1("fsc_ZP3SC1","",0,-5,5);
  L_ZP3SC1->add(fsc_ZP3SC1);
  L_ZP3SC1->add(RooRealConstant::value(-0.5));
  L_ZP3SC1->add(RooRealConstant::value(0.));
  RooRealVar typeZP3SC1("typeZP3SC1","",RKMNew);
  L_ZP3SC1->add(typeZP3SC1);  //type
  L_ZP3SC1->add(RooRealConstant::value(3));  //2 x spin
  L_ZP3SC1->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP3SC2("a_Bp_ZP3SC2","",0.001);
  RooRealVar p_Bp_ZP3SC2("p_Bp_ZP3SC2","",0.001);
  RooRealVar a_L0_ZP3SC2("a_L0_ZP3SC2","",0.001);
  RooRealVar p_L0_ZP3SC2("p_L0_ZP3SC2","",0.001);
  RooRealVar a_L1_ZP3SC2("a_L1_ZP3SC2","",0.001);
  RooRealVar p_L1_ZP3SC2("p_L1_ZP3SC2","",0.001);
  RooRealVar a_L2_ZP3SC2("a_L2_ZP3SC2","",0.001);
  RooRealVar p_L2_ZP3SC2("p_L2_ZP3SC2","",0.001);

  RooArgList* L_ZP3SC2 = new RooArgList(a_Bp_ZP3SC1,p_Bp_ZP3SC1,
              a_L0_ZP3SC1,p_L0_ZP3SC1,
              a_L1_ZP3SC1,p_L1_ZP3SC1,
              a_L2_ZP3SC1,p_L2_ZP3SC1,"L_ZP3SC1");
  RooRealVar fsc_ZP3SC2("fsc_ZP3SC2","",0,-5,5);
  L_ZP3SC2->add(fsc_ZP3SC2);
  L_ZP3SC2->add(RooRealConstant::value(-0.5));
  L_ZP3SC2->add(RooRealConstant::value(0.));
  RooRealVar typeZP3SC2("typeZP3SC2","",RKMNew);
  L_ZP3SC2->add(typeZP3SC2);  //type
  L_ZP3SC2->add(RooRealConstant::value(3));  //2 x spin
  L_ZP3SC2->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP3SC3("a_Bp_ZP3SC3","",0.001);
  RooRealVar p_Bp_ZP3SC3("p_Bp_ZP3SC3","",0.001);
  RooRealVar a_L0_ZP3SC3("a_L0_ZP3SC3","",0.001);
  RooRealVar p_L0_ZP3SC3("p_L0_ZP3SC3","",0.001);
  RooRealVar a_L1_ZP3SC3("a_L1_ZP3SC3","",0.001);
  RooRealVar p_L1_ZP3SC3("p_L1_ZP3SC3","",0.001);
  RooRealVar a_L2_ZP3SC3("a_L2_ZP3SC3","",0.001);
  RooRealVar p_L2_ZP3SC3("p_L2_ZP3SC3","",0.001);

  RooArgList* L_ZP3SC3 = new RooArgList(a_Bp_ZP3SC1,p_Bp_ZP3SC1,
              a_L0_ZP3SC1,p_L0_ZP3SC1,
              a_L1_ZP3SC1,p_L1_ZP3SC1,
              a_L2_ZP3SC1,p_L2_ZP3SC1,"L_ZP3SC1");
  RooRealVar fsc_ZP3SC3("fsc_ZP3SC3","",0,-5,5);
  L_ZP3SC3->add(fsc_ZP3SC3);
  L_ZP3SC3->add(RooRealConstant::value(-0.5));
  L_ZP3SC3->add(RooRealConstant::value(0.));
  RooRealVar typeZP3SC3("typeZP3SC3","",RKMNew);
  L_ZP3SC3->add(typeZP3SC3);  //type
  L_ZP3SC3->add(RooRealConstant::value(3));  //2 x spin
  L_ZP3SC3->add(RooRealConstant::value(1));  //parity

  RooRealVar a_Bp_ZP3SC4("a_Bp_ZP3SC4","",0.001);
  RooRealVar p_Bp_ZP3SC4("p_Bp_ZP3SC4","",0.001);
  RooRealVar a_L0_ZP3SC4("a_L0_ZP3SC4","",0.001);
  RooRealVar p_L0_ZP3SC4("p_L0_ZP3SC4","",0.001);
  RooRealVar a_L1_ZP3SC4("a_L1_ZP3SC4","",0.001);
  RooRealVar p_L1_ZP3SC4("p_L1_ZP3SC4","",0.001);
  RooRealVar a_L2_ZP3SC4("a_L2_ZP3SC4","",0.001);
  RooRealVar p_L2_ZP3SC4("p_L2_ZP3SC4","",0.001);

  RooArgList* L_ZP3SC4 = new RooArgList(a_Bp_ZP3SC1,p_Bp_ZP3SC1,
              a_L0_ZP3SC1,p_L0_ZP3SC1,
              a_L1_ZP3SC1,p_L1_ZP3SC1,
              a_L2_ZP3SC1,p_L2_ZP3SC1,"L_ZP3SC1");
  RooRealVar fsc_ZP3SC4("fsc_ZP3SC4","",0,-5,5);
  L_ZP3SC4->add(fsc_ZP3SC4);
  L_ZP3SC4->add(RooRealConstant::value(-0.5));
  L_ZP3SC4->add(RooRealConstant::value(0.));
  RooRealVar typeZP3SC4("typeZP3SC4","",RKMNew);
  L_ZP3SC4->add(typeZP3SC4);  //type
  L_ZP3SC4->add(RooRealConstant::value(3));  //2 x spin
  L_ZP3SC4->add(RooRealConstant::value(1));  //parity
