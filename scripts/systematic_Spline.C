...
int main(int argc, char **argv) {
    ...
    Static_Check::Counters::check_spline_and_KM_channels<25,   // Number of spline knots
                                                         6>(); // Maximum resonances per
                                                               // K-matrix channels
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        ...
        argv,
        "systematic_Spline",
        "Fits systematic model: Extra knot in the spline function");
...
#include "RooTDalitz/ResL_systematic_spline.h"
