...
//  setdlz->readFromFile("func/floatZFloat18L-KM6PcSPLS01-IndividualLS_floatL-4440p3-4457p1-4380m1-4312m1-4500m3-broadm3-setLError-AllFlPc.func");
  setdlz->readFromFile("func/testKMExt4L4Pc-4440m1-4457m3-4312m1-4600p3.func");
  //test.func");
//  setdlz->readFromFile("func/testKMExt4L4Pc-4440m1-4457m3-4312m1-4600p3.func");
...
//  if(!(ZS4==3&&ZP4==1)) {
  ...
  double NLL2 ;
  setdlz->readFromFile(TString::Format("func/for_gen_toy/testKMExt4L4Pc-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());

//  NLL2= doFit(obs, list, listZ, listX,  data_fit, 0, false, errlist);   

//  setdlz->writeToFile(TString::Format("func/testKMExt4L4Pc-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
//  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKMExt4L4Pc-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data());
  signew->Delete(); 
  }
  return 0;
  if(1) {
...
//#ifndef fit  
  ...
  NLL2 = doFitMinos(obs, list, listZ, listX,  data_fit, 0, true, errlist, minosList);   
#endif  
//#endif
