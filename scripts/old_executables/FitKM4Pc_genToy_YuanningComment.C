...
//   printf("LLCheck-all-26: %10.3f,  %10.3f\n",NLL2,ll26);
  ...
  if(1){
  RooDalitzAmplitude *signew = new RooDalitzAmplitude("signew","", *obs, list, listZ, listX, "../check_Lst_impact/create_tuple/mcsw_forYuanning_Comment.root",*data_fit);
//  setdlznew = setdlz;
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("../check_Lst_impact/create_tuple/mcsw_forYuanning_Comment.root",outputname);
  signew->Delete(); 
  }
  if(1) {
