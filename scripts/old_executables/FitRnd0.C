...
//  setdlz->readFromFile("test9.func");
  setdlz->readFromFile("func/testKMOldFixL-4440m3-4457m1-4312m1.func");

#if 1
  FloatZPar(L_Z,false,true);
  FloatZPar(L_Z4,false,true);
  FloatZPar(L_ZM1SC1,false);
  FloatZPar(L_ZM1SC2,false);  
  FloatZPar(L_ZM1SC3,false);
  FloatZPar(L_ZM1SC4,false);
  FloatZPar(L_Z5,false,true);
