...
//  setdlz->readFromFile("best4.func");
//  setdlz->readFromFile("test.func");  
//  setdlz->readFromFile(TString::Format("func/testKM3PcS-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
#ifdef Extended
  setdlz->readFromFile(TString::Format("func/testKMExt4L4Pc-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
#else
...
#ifdef Extended  
  SetLPar(L_2130, 1, true);
  SetLPar(L_1910, 6, true);
  SetLPar(L_2340, 1, true);  
  SetLPar(L_2320, 1, true);    
  ...
  RooArgSet *minosList = new RooArgSet();
  minosList->add(m0_Z4);
  minosList->add(g1_Z4);
  minosList->add(rg4_Z4);  
  double NLL2 = doFitMinos(obs, list, listZ,  data_fit, 0, true, errlist, minosList);   
