...
//  setdlz->readFromFile("test9.func");
  setdlz->readFromFile("logsav/testKM3-4440m3-4457p1-4312m1.func");
...
//  m0_Z5.setVal(4.440);//3/2-
  ...
  setdlz->writeToFile(TString::Format("func/testKM4-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM4-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
