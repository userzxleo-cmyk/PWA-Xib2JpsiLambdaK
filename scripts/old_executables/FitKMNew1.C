...
//  setdlz->readFromFile("test9.func");
  ...
  if(!(ZS4==1&&ZP4==-1)) FloatZPar(L_Z4,true); //4312
  if(!(ZS==3&&ZP==-1)) FloatZPar(L_Z,true);//4457
  if(!(ZS5==1&&ZP5==-1)) FloatZPar(L_Z5,true); //4440
...
//  m0_Z5.setVal(4.440);//3/2-
  ...
  p_Bp_ZM1SC1.setConstant(0);
  a_Bp_ZM1SC1.setConstant(0);
  p_Bp_ZM3SC1.setConstant(0);
  a_Bp_ZM3SC1.setConstant(0);
  rg2_Z.setRange(-50,50); rg2_Z.setConstant(0);
  rg2_Z4.setVal(0); rg2_Z4.setConstant(1);
  rg2_Z5.setRange(-50,50); rg2_Z5.setConstant(0);
  rg3_Z.setVal(0); rg3_Z.setConstant(1);
  rg3_Z4.setVal(0); rg3_Z4.setConstant(1);
  rg3_Z5.setVal(0); rg3_Z5.setConstant(1);
  rg4_Z.setRange(-50,50); rg4_Z.setConstant(0);
  rg4_Z4.setRange(-50,50); rg4_Z4.setConstant(0);
  rg4_Z5.setRange(-50,50); rg4_Z5.setConstant(0);
  m0_Z.setRange(4.452 , 4.47);
  m0_Z4.setRange(4.309 , 4.333);    
  m0_Z5.setRange(4.426 , 4.453);
#endif
#if 1
  RotatePar(L_Z,TComplex(1.6758,-0.144458),true);
  RotatePar(L_Z4,TComplex(1.6758,-0.144458),true);
  RotatePar(L_Z5,TComplex(1.6758,-0.144458),true);//4457  
  RotatePar(L_ZM1SC1,TComplex(1.6758,-0.144458),true);    
  RotatePar(L_ZM3SC1,TComplex(1.6758,-0.144458),true);      

  RotatePar(L_S01,TComplex(1.6758,-0.144458));  
  RotatePar(L_S01_2,TComplex(1.6758,-0.144458));    
  RotatePar(L_1520,TComplex(1.6758,-0.144458));  
  RotatePar(L_1600,TComplex(1.6758,-0.144458));  
//  RotatePar(L_1670,TComplex(1.6758,-0.144458));  
  RotatePar(L_1690,TComplex(1.6758,-0.144458));  
//  RotatePar(L_1800,TComplex(1.6758,-0.144458));  
  RotatePar(L_1810,TComplex(1.6758,-0.144458));  
  RotatePar(L_1820,TComplex(1.6758,-0.144458));  
  RotatePar(L_1830,TComplex(1.6758,-0.144458));
  RotatePar(L_1890,TComplex(1.6758,-0.144458));
  RotatePar(L_2100,TComplex(1.6758,-0.144458));    
  RotatePar(L_2110,TComplex(1.6758,-0.144458));      
  RotatePar(L_2350,TComplex(1.6758,-0.144458));    
  RotatePar(L_2585,TComplex(1.6758,-0.144458));  
  RotatePar(L_1710,TComplex(1.6758,-0.144458));  
//  RotatePar(L_2000,TComplex(1.6758,-0.144458));  
  RotatePar(L_2020,TComplex(1.6758,-0.144458));  
  RotatePar(L_2050,TComplex(1.6758,-0.144458));  
  a_p1p1_1600.setVal(1); a_p1p1_1600.setConstant(1);
   p_p1p1_1600.setVal(0); p_p1p1_1600.setConstant(1);
   a_p100_1520.setConstant(0);
   p_p100_1520.setConstant(0);
   a_Bp_Z.setVal(0); 
a_Bp_Z4.setVal(0);  
a_Bp_Z5.setVal(0);  
a_Bp_ZM1SC1.setVal(0); 
a_Bp_ZM3SC1.setVal(0); 
p_Bp_Z.setVal(0); 
p_Bp_Z4.setVal(0); 
p_Bp_Z5.setVal(0); 
p_Bp_ZM1SC1.setVal(0); 
p_Bp_ZM3SC1.setVal(0); 

   a_Bp_Z.setConstant(1); 
a_Bp_Z4.setConstant(1);  
a_Bp_Z5.setConstant(1);  
a_Bp_ZM1SC1.setConstant(1); 
a_Bp_ZM3SC1.setConstant(1); 
p_Bp_Z.setConstant(1); 
p_Bp_Z4.setConstant(1); 
p_Bp_Z5.setConstant(1); 
p_Bp_ZM1SC1.setConstant(1); 
p_Bp_ZM3SC1.setConstant(1); 
#endif
  setdlz->Print("V");  
  sig->Delete();     
  
  #if 1
   double NLL2 = doFit(obs, list, listZ,  data_fit, 0, true, errlist);    
  setdlz->writeToFile(TString::Format("func/testKM3-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM3-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
