...
//  setdlz->readFromFile("func/testKM3PcS-4440m3-4457m1-4312p3.func");
  //test.func");
  setdlz->readFromFile("func/testKM3PcS-4440m1-4457m3-4312m1.func");
...
//  if(!(ZS4==3&&ZP4==1)) {
  ...
  setdlz->writeToFile(TString::Format("func/testKM3PcS-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM3PcS-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
