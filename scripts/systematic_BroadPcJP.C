...
int main(int argc, char **argv) {
    ...
    Static_Check::Counters::check_spline_and_KM_channels<24,   // Number of spline knots
                                                         7>(); // Maximum resonances per
                                                               // K-matrix channels
    ...
    auto parser_args =
        Parser::parse_args<has_broad_Pc>(argc,
                                         argv,
                                         "systematic_BroadPcJP",
                                         "Fits systematic model: Broad Pc different spin-parity");
