...
RANDOM_ARGS="--seed ${SEED} --randomLs --randomPc --largeRandom"

/home/dtou01/Lb2JpsipK/lb2jpsipk_run12_aman/bin/FitAlternateCouplings0 ${PC_ARGS} ${INPUT_ARGS} ${OUTPUT_ARGS} ${RANDOM_ARGS}
