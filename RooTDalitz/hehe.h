...
//Add more additional states
  ...
  RooArgList* L_2330 = new RooArgList(a_p1p1_P01,p_p1p1_P01,
                                      a_p100_P01,p_p100_P01,
                                      a_m100_P01,p_m100_P01,
                                      a_m1m1_P01,p_m1m1_P01,"L_2330");
  L_2330->add(a_p3p1_P01);
  L_2330->add(p_p3p1_P01);
  L_2330->add(a_m3m1_P01);
  L_2330->add(p_m3m1_P01);
  L_2330->add(a_2330);
  L_2330->add(p_2330);
  L_2330->add(m0_2330);
  ...
  RooArgList* L_2130 = new RooArgList(a_p1p1_F05,p_p1p1_F05,
                                      a_p100_F05,p_p100_F05,
                                      a_m100_F05,p_m100_F05,
                                      a_m1m1_F05,p_m1m1_F05,"L_2130");
  L_2130->add(a_p3p1_F05);
  L_2130->add(p_p3p1_F05);
  L_2130->add(a_m3m1_F05);
  L_2130->add(p_m3m1_F05);
  L_2130->add(a_2130);
  L_2130->add(p_2130);
  L_2130->add(m0_2130);
  ...
  RooArgList* L_2310 = new RooArgList(a_p1p1_F05,p_p1p1_F05,
                                      a_p100_F05,p_p100_F05,
                                      a_m100_F05,p_m100_F05,
                                      a_m1m1_F05,p_m1m1_F05,"L_2310");
  L_2310->add(a_p3p1_F05);
  L_2310->add(p_p3p1_F05);
  L_2310->add(a_m3m1_F05);
  L_2310->add(p_m3m1_F05);
  L_2310->add(a_2310);
  L_2310->add(p_2310);
  L_2310->add(m0_2310);
