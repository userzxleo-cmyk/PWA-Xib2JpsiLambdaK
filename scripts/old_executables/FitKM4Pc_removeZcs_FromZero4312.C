...
//  p_L2_Z4.setError(0.1);
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-removeZcs-FromZero4312-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl;
  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist);

  setdlz->writeToFile(TString::Format("func/testKM4Pc-removeZcs-FromZero4312-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM4Pc-removeZcs-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data());
  signew->Delete(); 
  }
  if(1) {
