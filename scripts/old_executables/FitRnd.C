...
//  setdlz->readFromFile("test9.func");
  setdlz->readFromFile("fixnew.func");
  ...
  SetLPar(L_1520,6,true);  
  SetLPar(L_1600,6,true);  
  SetLPar(L_1690,6,true);  
  SetLPar(L_1810,6,true);  
  SetLPar(L_1820,6,true);  
  SetLPar(L_1830,6,true);
  SetLPar(L_1890,6,true);
  SetLPar(L_2100,6,true);    
  SetLPar(L_2110,6,true);      
  SetLPar(L_2350,6,true);    
  SetLPar(L_2585,4,true);  
  SetLPar(L_1710,6,true);  
  SetLPar(L_2020,6,true);  
  SetLPar(L_2050,6,true);  
  SetLPar(L_NR,6,true);  
  SetLPar(L_1405,6,true);
  SetLPar(L_1670,6,true);
  SetLPar(L_1800,6,true);
  SetLPar(L_2000,6,true);
  a_p100_1520.setVal(1);a_p100_1520.setConstant(1);
  p_p100_1520.setVal(0); p_p100_1520.setConstant(1);  
  m0_1520.setConstant(0);
  width_1520.setConstant(0);  
fsc_ZM1SC1.setConstant(0);
fsc_ZM1SC2.setConstant(0);
fsc_ZM1SC3.setConstant(0);
fsc_ZM1SC4.setConstant(0);
fsc_ZM3SC1.setConstant(0);
fsc_ZM3SC2.setConstant(0);
fsc_ZM3SC3.setConstant(0);
fsc_ZM3SC4.setConstant(0);
  
  /*
  if(!(ZS4==1&&ZP4==-1)) FloatZPar(L_Z4,true); //4312
  if(!(ZS==1&&ZP==-1)) FloatZPar(L_Z,true);//4457
  if(!(ZS5==3&&ZP5==1)) FloatZPar(L_Z5,true); //4440
  */
...
//  g1_Z.setVal(0.359204);
//  g1_Z4.setVal(0.359204);  
//  g1_Z5.setVal(0.359204);  
#if 0
  g2_Z4.setConstant(1);
  g2_Z5.setVal(0);       g2_Z5.setConstant(1);
  g2_Z.setConstant(1);
  g3_Z4.setConstant(1);
  g3_Z5.setVal(0);       g3_Z5.setConstant(1);
  g3_Z.setConstant(1);
  g4_Z4.setConstant(1);
  g4_Z5.setVal(0);       g4_Z5.setConstant(1);
  g4_Z.setConstant(1);

  

#endif
//  width_1405.setVal(0.0505);
// width_1405.setConstant(1);
  width_1405.setRange(0.02,0.5);
  width_1405.setConstant(0);
...
g4_Z5.setRange(-2,2);
   ...
   #endif
   exit(0);
  setdlz->writeToFile(TString::Format("func/testKMOldFixL-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKMOldFixL-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
