...
//  rg4_Z4.setConstant(0);    
  setdlz->readFromFile(TString::Format("func/testKM4Pc-4440%s-4457%s-4312m1-4600%s.func",nameZ5, name,nameZ2).Data());  
  std::cout << "read from file " << TString::Format("func/testKM4Pc-4440%s-4457%s-4312m1-4600%s.func",nameZ5, name,nameZ2).Data() << std::endl;

  std::cout << "will write to file " << TString::Format("func/testKM4Pc-forOther4600JP-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl; 
  double a0=a_p1p1_1600.getVal();
  double p0=p_p1p1_1600.getVal();

  FloatZPar(L_Z,false,RND);
  FloatZPar(L_Z4,true,RND);
#ifdef FourPc
  ...
  setdlz->writeToFile(TString::Format("func/testKM4Pc-forOther4600JP-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM4Pc-forOther4600JP-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data());
  signew->Delete(); 
  }
  if(1) {
