...
//  std::cout << "process is done" << std::endl;   
  if(1){
  RooDalitzAmplitude *signew = new RooDalitzAmplitude("signew","", *obs, list, listZ, TString::Format("../gen_toys/assign_Lb_mass/output/phsp_withangle_withLbMass_"+component_label+"_%d.root", iMultiCore),*data_fit, true);
//  setdlznew = setdlz;
