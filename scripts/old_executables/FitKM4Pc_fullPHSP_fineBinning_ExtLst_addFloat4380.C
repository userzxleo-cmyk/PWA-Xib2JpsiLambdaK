...
//   m0_2320.setRange(1.45, 2.6);
   ...
   m0_Z3.setRange(4.35, 4.41);
   m0_Z3.setConstant(0);
   m0_Z3.setError(0.001);
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-fullPHSP-fineBinning-ExtLst-addFloat4380-4440%s-4457%s-4312%s-4600%s-4380%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2,nameZ3).Data() << std::endl;

  NLL2 = doFit(obs, list, listZ, listX,  data_fit, FFR_var, FFB_var, 0, true, errlist);

  setdlz->writeToFile(TString::Format("func/testKM4Pc-fullPHSP-fineBinning-ExtLst-addFloat4380-4440%s-4457%s-4312%s-4600%s-4380%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2, nameZ3).Data());
  return 0;
  setdlz->Print("V");
