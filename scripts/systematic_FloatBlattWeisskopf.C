...
int main(int argc, char **argv) {
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        argc,
        argv,
        "systematic_FloatBlattWeisskopf",
        "Fits systematic model: Float Blatt-Weisskopf form factor");
...
#include "RooTDalitz/ResZKM_alternateCoupling.h"
    ...
    auto arguments =
        Execution::get_arguments(list,
                                 listZ,
                                 listX,
                                 ratioList,
                                 500000,
                                 false,   // Float Blatt-Weisskopf form factor for systematic
