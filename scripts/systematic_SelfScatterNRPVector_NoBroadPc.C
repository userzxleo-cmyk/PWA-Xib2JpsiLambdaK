...
int main(int argc, char **argv) {
    ...
    Static_Check::Resonances::check_count<20,        // number of Lz,
                                          11,        // number of Pc,
                                          0>();      // number of Zcs
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        argc,
        argv,
        "systematic_SelfScatterNRPVector_NoBroadPc",
        "Fits systematic model: (1) K-matrix channels have different non-resonant P-vector term "
        ", (2) Sigmac(*)D(*) channels have non-zero self-scattering terms and (3) no broad Pc");
