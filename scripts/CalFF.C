...
//  setdlz->readFromFile("func/testKM3PcS-4440m3-4457m1-4312p3.func");
  //test.func");
#if 1
  setdlz->readFromFile("func/testKMExtL4Pc-4440m1-4457m3-4312m1-4600p3.func");
#else
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("TestKMExtL4Pc-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data(), true, true, true);
  signew->Delete(); 
  }
  if(1) {
