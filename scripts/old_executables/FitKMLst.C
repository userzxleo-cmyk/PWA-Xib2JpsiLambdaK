...
//  RotatePar(L_2000,TComplex(1.6758,-0.144458));  
  ...
  a_Bp_Z.setVal(0); a_Bp_Z.setConstant(1);
  p_Bp_Z.setVal(0); p_Bp_Z.setConstant(1);  
  a_Bp_Z4.setVal(0); a_Bp_Z4.setConstant(1);
  p_Bp_Z4.setVal(0); p_Bp_Z4.setConstant(1);  
  a_Bp_Z5.setVal(0); a_Bp_Z5.setConstant(1);
  p_Bp_Z5.setVal(0); p_Bp_Z5.setConstant(1);  

#endif
  a_p1p1_1600.setConstant(1);
  p_p1p1_1600.setConstant(1);
  ...
  rg4_Z.setConstant(1); rg4_Z.setVal(0);  
  rg4_Z5.setConstant(1); rg4_Z5.setVal(0);
  ...
  setdlz->writeToFile(TString::Format("func/testKMLst-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKMLst-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
