...
//  cosk:cosmu:chi
  ...
  obs1->add(sw);
  TFile *fdata = new TFile("../gen_toys/fit_for_sw/output/testKM4Pc-4440m1-4457m3-4312m3-4600p3-22.root");
...
//  rg4_Z4.setConstant(0);    
  setdlz->readFromFile("func/Seed-testKM4Pc-4440m1-4457m3-4312p3-4600p3-25-Fit-testKM4Pc-4440m1-4457m3-4312p3-4600p3.func");  
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKM4Pc-4440%s-4457%s-4312%s-4600%s",nameZ5, name, nameZ4,nameZ2).Data());
  signew->Delete(); 
  }
  if(1) {
