...
//   m0_2320.setRange(1.45, 2.6);
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-fullPHSP-fineBinning-ExtLst-addNarrow4380-fromZero4312-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl;


  NLL2 = doFit(obs, list, listZ, listX,  data_fit, FFR_var, FFB_var, 0, true, errlist);


  setdlz->writeToFile(TString::Format("func/testKM4Pc-fullPHSP-fineBinning-ExtLst-addNarrow4380-fromZero4312-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data());
  return 0;
  setdlz->Print("V");
