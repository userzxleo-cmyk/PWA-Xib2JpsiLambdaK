...
//Z4 4312
  ...
  RooArgList* L_Z = new RooArgList(a_Bp_Z,p_Bp_Z,
              ...
              a_L2_Z,p_L2_Z,"L_Z");
//four more couplings
  RooRealVar g1_Z("g1_Z","g1_Z",0.3,-1,1);
  RooRealVar rg2_Z("rg2_Z","rg2_Z",0.0);
  RooRealVar rg3_Z("rg3_Z","rg3_Z",0.);
  RooRealVar rg4_Z("rg4_Z","rg4_Z",0.01,-50,50);
  ...
  L_Z->add(g4_Z);
  L_Z->add(m0_Z);
  L_Z->add(RooRealConstant::value(0.)); // No threshold effect for Pc(4457)
  ...
  L_Z4->add(g4_Z4);
  L_Z4->add(m0_Z4);
  L_Z4->add(RooRealConstant::value(0.)); // No threshold effect for Pc(4312)
  ...
  RooRealVar g1_Z5("g1_Z5","",0.3,-2,2);  //jpsi p
  RooRealVar rg2_Z5("rg2_Z5","",0.3,-50,50);  //sigma D*
  RooRealVar rg3_Z5("rg3_Z5","",0);  //sigma*D*
  RooRealVar rg4_Z5("rg4_Z5","",0.05,-50,50);  //sigma(*)D
  RooFormulaVar g2_Z5("g2_Z5","@0*@1",RooArgSet(g1_Z5,rg2_Z5));
  RooFormulaVar g3_Z5("g3_Z5","@0*@1",RooArgSet(g1_Z5,rg3_Z5));
  RooFormulaVar g4_Z5("g4_Z5","@0*@1",RooArgSet(g1_Z5,rg4_Z5));
  L_Z5->add(g1_Z5);
  L_Z5->add(g2_Z5);
  L_Z5->add(g3_Z5);
  L_Z5->add(g4_Z5);
  L_Z5->add(m0_Z5);
  L_Z5->add(RooRealConstant::value(0.)); // No threshold effect for Pc(4440)
