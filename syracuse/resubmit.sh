...
/home/dtou01/Lb2JpsipK/lb2jpsipk_run12_aman/bin/FitKM4Pc_fullPHSP_fineBinning_ExtLst_openCoupleChannel_ImMass_smartSmearing_smartbinning_limitwidth_ReRunFail ${P4440} -1 ${P4457} -1 1 -1 3 1 initial_${TAG} final_${TAG} ${TAG}  ${scale_number} ${lowerlimit} 100.
