...
int main(int argc, char **argv)
{
 ...
 std::cout << "Time(begin)  " << BeginTime.GetYear() << "." << BeginTime.GetMonth() << "." << BeginTime.GetDay() << "    " << BeginTime.GetHour() << ":" << BeginTime.GetMinute() << ":" << BeginTime.GetSecond() << std::endl; 
  ...
  std::cout << "Fit molecular 4380 J P fix " << ZS3 << " " << ZP3 << std::endl;
...
//  p_L2_Z4.setError(0.1);
  ...
  if(ZS4==1 && ZP4==-1 && ZS5==1 && ZP5==-1 && ZS==3 && ZP==-1) {
          m0_Z3.setVal(4.3765);
          g1_Z3.setVal(0.338);
  }
  else if(ZS4==1 && ZP4==-1 && ZS5==3 && ZP5==-1 && ZS==1 && ZP==-1) {
          m0_Z3.setVal(4.3711);
          g1_Z3.setVal(0.431);
  }
  else{
        std::cout << "only test molecular JP of narrow state. check it" << std::endl;
        return 0;
  }

   m0_Z3.setRange(4.3, 4.43);
   m0_Z3.setConstant(0);
   m0_Z3.setError(0.01);
   g1_Z3.setRange(0.01, 10.);
   g1_Z3.setConstant(0);
   g1_Z3.setError(0.1);

   rg4_Z3.setRange(-50, 50);
   rg4_Z3.setVal(0.1);
   rg4_Z3.setError(0.1);
   rg4_Z3.setConstant(0);
...
//   m0_2320.setRange(1.45, 2.6);
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-fullPHSP-fineBinning_ExtLst_openCoupleChannel_addNarrow4380-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl;


  NLL2 = doFit(obs, list, listZ, listX,  data_fit, fitresultName, FFR_var, FFB_var,  0, true, errlist, false, false);

  setdlz->writeToFile(TString::Format("func/testKM4Pc-fullPHSP-fineBinning_ExtLst_openCoupleChannel_addNarrow4380-4440%s-4457%s-4312%s-4600%s-"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2).Data());
  setdlz->Print("V");
