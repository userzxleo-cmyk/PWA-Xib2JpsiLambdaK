...
//four more couplings
  ...
  L_ZM1SC1->add(fsc_ZM1SC1); // For Jpsip channel, fsc = self-scattering
  ...
  RooRealVar self_fsc_ZM1SC2("self_fsc_ZM1SC2","",0,-20,20); // linear term in production vector
  L_ZM1SC2->add(fsc_ZM1SC2);
  L_ZM1SC2->add(self_fsc_ZM1SC2);
  ...
  RooRealVar self_fsc_ZM1SC3("self_fsc_ZM1SC3","",0,-20,20); // linear term in production vector
  L_ZM1SC3->add(fsc_ZM1SC3);
  L_ZM1SC3->add(self_fsc_ZM1SC3);
  ...
  RooRealVar self_fsc_ZM1SC4("self_fsc_ZM1SC4","",0,-20,20); // linear term in production vector
  L_ZM1SC4->add(fsc_ZM1SC4);
  L_ZM1SC4->add(self_fsc_ZM1SC4);
  ...
  L_ZM3SC1->add(fsc_ZM3SC1); // For Jpsip channel, fsc = self-scattering
  ...
  RooRealVar self_fsc_ZM3SC2("self_fsc_ZM3SC2","",0,-20,20); // linear term in production vector
  L_ZM3SC2->add(fsc_ZM3SC2);
  L_ZM3SC2->add(self_fsc_ZM3SC2);
  ...
  RooRealVar self_fsc_ZM3SC3("self_fsc_ZM3SC3","",0,-20,20); // linear term in production vector
  L_ZM3SC3->add(fsc_ZM3SC3);
  L_ZM3SC3->add(self_fsc_ZM3SC3);
  ...
  RooRealVar self_fsc_ZM3SC4("self_fsc_ZM3SC4","",0,-20,20); // linear term in production vector
  L_ZM3SC4->add(fsc_ZM3SC4);
  L_ZM3SC4->add(self_fsc_ZM3SC4);
