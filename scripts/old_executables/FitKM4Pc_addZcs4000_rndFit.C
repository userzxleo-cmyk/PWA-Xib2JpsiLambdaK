...
int main(int argc, char **argv)
{
 ...
 std::cout << "Time(begin)  " << BeginTime.GetYear() << "." << BeginTime.GetMonth() << "." << BeginTime.GetDay() << "    " << BeginTime.GetHour() << ":" << BeginTime.GetMinute() << ":" << BeginTime.GetSecond() << std::endl; 
  ...
  TString label_for_output = TString(argv[11]);
...
//  setdlz->readFromFile(TString::Format("func/testKM4Pc-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data()); 
  ...
  std::cout << "write to file: " << TString::Format("func/testKM4Pc-addZcs4000-rndFit-4440%s-4457%s-4312%s-4600%s-seed%d"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2, seed).Data() << std::endl;
  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist);

  setdlz->writeToFile(TString::Format("func/testKM4Pc-addZcs4000-rndFit-4440%s-4457%s-4312%s-4600%s-seed%d"+label_for_output+".func",nameZ5, name, nameZ4,nameZ2, seed).Data());
  setdlz->Print("V");
