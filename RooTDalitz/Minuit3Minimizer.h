...
//   Basically the same as Minuit2Minimizer but with MinimumState exposed via public function

#ifndef ROOT_Minuit3_Minuit3Minimizer
#define ROOT_Minuit3_Minuit3Minimizer
