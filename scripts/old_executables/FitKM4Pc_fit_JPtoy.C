...
//  rg4_Z4.setConstant(0);    
  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist, true);  
  setdlz->Print("V");
...
//  std::cout << "process is done" << std::endl;   
  if(0){
  RooDalitzAmplitude *signew = new RooDalitzAmplitude("signew","", *obs, list, listZ, listX, "mcsw.root",*data_fit, true);
//  setdlznew = setdlz;
