...
//four more couplings
  ...
  RooRealVar b1prod_ZM1SC1("b1prod_ZM1SC1","",0,-20,20); // linear term in production vector
  L_ZM1SC1->add(fsc_ZM1SC1);
  L_ZM1SC1->add(b1prod_ZM1SC1);
  ...
  RooRealVar b1prod_ZM1SC2("b1prod_ZM1SC2","",0,-20,20); // linear term in production vector
  L_ZM1SC2->add(fsc_ZM1SC2);
  L_ZM1SC2->add(b1prod_ZM1SC2);
  ...
  RooRealVar b1prod_ZM1SC3("b1prod_ZM1SC3","",0,-20,20); // linear term in production vector
  L_ZM1SC3->add(fsc_ZM1SC3);
  L_ZM1SC3->add(b1prod_ZM1SC3);
  ...
  RooRealVar b1prod_ZM1SC4("b1prod_ZM1SC4","",0,-20,20); // linear term in production vector
  L_ZM1SC4->add(fsc_ZM1SC4);
  L_ZM1SC4->add(b1prod_ZM1SC4);
  ...
  RooRealVar b1prod_ZM3SC1("b1prod_ZM3SC1","",0,-20,20); // linear term in production vector
  L_ZM3SC1->add(fsc_ZM3SC1);
  L_ZM3SC1->add(b1prod_ZM3SC1);
  ...
  RooRealVar b1prod_ZM3SC2("b1prod_ZM3SC2","",0,-20,20); // linear term in production vector
  L_ZM3SC2->add(fsc_ZM3SC2);
  L_ZM3SC2->add(b1prod_ZM3SC2);
  ...
  RooRealVar b1prod_ZM3SC3("b1prod_ZM3SC3","",0,-20,20); // linear term in production vector
  L_ZM3SC3->add(fsc_ZM3SC3);
  L_ZM3SC3->add(b1prod_ZM3SC3);
  ...
  RooRealVar b1prod_ZM3SC4("b1prod_ZM3SC4","",0,-20,20); // linear term in production vector
  L_ZM3SC4->add(fsc_ZM3SC4);
  L_ZM3SC4->add(b1prod_ZM3SC4);
