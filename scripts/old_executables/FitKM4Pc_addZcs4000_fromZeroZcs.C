...
//  rg4_Z4.setConstant(0);    
  ...
  std::cout << "will write to file: " << TString::Format("func/testKM4Pc-addZcs4000-fromZeroZcs-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data() << std::endl;
  NLL2 = doFit(obs, list, listZ, listX,  data_fit, 0, true, errlist);  
  setdlz->writeToFile(TString::Format("func/testKM4Pc-addZcs4000-fromZeroZcs-4440%s-4457%s-4312%s-4600%s.func",nameZ5, name, nameZ4,nameZ2).Data());
  setdlz->Print("V");
