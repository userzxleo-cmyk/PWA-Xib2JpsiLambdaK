...
#endif 
//  //Only S-wave coupling considered
//  if(!(ZS4==1&&ZP4==-1)) { //Sigmac D channel for 4312 
//    rg4_Z4.setVal(0); rg4_Z4.setConstant(1);
//  }  
//  if(!((ZS==1&&ZP==-1) || (ZS==3&&ZP==-1))) { //Sigmac D* channel for 4457 
//    rg2_Z.setVal(0); rg2_Z.setConstant(1);
//  }  
//  if(!((ZS5==1&&ZP5==-1) || (ZS5==3&&ZP5==-1))) { //Sigmac D* channel for 4440 
...
//  m0_Z4.setError(0.0001);
  ...
  //Consider only the S-wave components
