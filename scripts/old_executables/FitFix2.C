...
//  setdlz->readFromFile("test9.func");
  setdlz->readFromFile("fix31.func");//fix.func");
...
//  m0_Z5.setVal(4.440);//3/2-
  ...
  g1_Z.setVal(0.497061);
  g1_Z4.setVal(0.372148);  
  g1_Z5.setVal(0.279153);  
  m0_Z.setVal(4.4573);//4457
  m0_Z4.setVal(4.3119);//4312
  m0_Z5.setVal(4.4403);//4440
  g1_Z.setConstant(1);
  g1_Z4.setConstant(1);
  g1_Z5.setConstant(1);
  m0_Z.setConstant(1);
...
#if 1
  g2_Z.setVal(0); g2_Z.setConstant(1);
  g3_Z.setVal(0); g3_Z.setConstant(1);  
  g4_Z.setVal(0); g4_Z.setConstant(1);  

  g2_Z4.setVal(0); g2_Z4.setConstant(1);
  g3_Z4.setVal(0); g3_Z4.setConstant(1);  
  g4_Z4.setVal(0); g4_Z4.setConstant(1);
