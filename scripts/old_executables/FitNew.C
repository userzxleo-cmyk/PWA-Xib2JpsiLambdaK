...
//  g1_Z5.setVal(0.359204);  
...
#endif
  p_Bp_Z5.setVal(0); a_Bp_Z5.setVal(0);
 ...
 // width_1405.setConstant(1);
  ...
  g1_Z5.setConstant(0);
  rg2_Z.setConstant(0); 
  rg2_Z4.setConstant(1);
  rg2_Z5.setConstant(0);
  rg3_Z.setConstant(1);      
  rg3_Z4.setConstant(1);
  rg3_Z5.setConstant(1);
  rg2_Z4.setVal(0);
  rg2_Z5.setVal(0);
  rg3_Z.setVal(0);      
  rg3_Z4.setVal(0);
 ...
 // NLL2 = doFit(obs, list, listZ,  data_fit, 0, true, errlist);         
  setdlz->writeToFile(TString::Format("func/testKMOldLNR-SCPc-4440%s-4457%s-4312%s.func",nameZ5, name, nameZ4).Data());
  setdlz->Print("V");
...
//  signew->genToy("Toy");        
  ...
  signew->genToy("mcsw.root",TString::Format("testKMOldLNR-SCPc-4440%s-4457%s-4312%s",nameZ5, name, nameZ4).Data());
  signew->Delete(); 
  }
  if(1) {
