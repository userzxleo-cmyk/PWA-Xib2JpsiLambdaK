...
int main(int argc, char **argv) {
    ...
    Static_Check::Resonances::check_count<17,   // number of Lz,
                                          12,   // number of Pc,
                                          0>(); // number of Zcs
    ...
    auto parser_args = Parser::parse_args<has_broad_Pc>(
        argc,
        argv,
        "systematic_Replace4NewLsWithNonResonant",
        "Fits systematic model: Replace 4 new Lz with non-resonant pK");
